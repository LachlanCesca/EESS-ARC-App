...
public class SetPreferenceActivity extends Activity implements
	OnItemClickListener {
    ...
    protected static final int FAILED_CONNECT = 2;
    protected static final int MESSAGE_READ = 1;
    IntentFilter filter;
    BroadcastReceiver receiver;
    String tag = "debugging";

    public static String theConnectedDevice;

    BluetoothDevice selectedDevice;
    ConnectThread connect;

    public static ConnectedThread myConnectedThread;
	...
	public void handleMessage(Message msg) {
	    ...
	    case FAILED_CONNECT:
		Toast.makeText(getApplicationContext(), "An Error Ocurred.", 0)
			.show();
		theConnectedDevice = null;
		break;
	    }
	}
    };
	...
	if (listAdapter.getItem(arg2).contains("Paired")) {
	    theConnectedDevice = listAdapter.getItem(arg2);
